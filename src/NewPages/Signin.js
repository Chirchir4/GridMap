            ...
            <div className="w-full">
               <div className="min-h-screen h-full flex flex-col after:flex-1">
                  ...
                  <div className="w-full sm:w-1/3 mx-auto px-4 py-8">
                     ...
                     <h1
                        className="text-lg text-slate-800 font-bold mb-6 
  sm:text-3xl sm:leading-tight"
                     ...
                     <form>
                        <div className="space-y-6">
                           ...
                           {mode === 'register' && (
                              <div>
                                 <label className="block text-lg text-slate-600 font-medium mb-1" htmlFor="email">
                                    User Name
                                 </label>
                                 <input
                                    id="username"
                                    className="form-input w-full  px-4 h-11 border-slate-300 "
                                    type="username"
                                    value={userName}
                                    onChange={(e) => {
                           ...
                           <div>
                              <label className="block text-lg text-slate-600  font-medium mb-1" htmlFor="password">
                                 Password
                              </label>
                              <input
                                 id="password"
                                 className="form-input w-full px-4 h-11 border border-slate-300"
                                 type="password"
                                 autoComplete="on"
                                 value={password}
                                 onChange={(e) => {
                        ...
                        <div className="flex items-center justify-between mt-6">
                           <div className="mr-1">
                              <Link className="text-md text-slate-600 underline hover:text-indigo-500" to="/reset-password">
                                 Forgot Password?
                              </Link>
                           </div>
                           <button
                              className="btn bg-indigo-500 hover:bg-indigo-600 px-3 py-2 sm:px-4 sm:py-3 rounded-md text-white ml-3"
